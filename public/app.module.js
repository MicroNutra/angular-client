(function () {
  'use strict'
  angular
    .module("app", ["app.dashboard", "ui.router", "angularMoment"])

  // require('./app.config.js');
  // require('./components/about/about.controller.js');
  // require('./components/about/about.component.js');
  // require('./components/about/about.module.js');
  //
  // require('./components/dashboard/dashboard.controller.js');
  // require('./components/dashboard/dashboard.component.js');
  // require('./components/dashboard/dashboard.module.js');
  //
  // require('./components/foodList/foodList.controller.js');
  // require('./components/foodList/foodList.component.js');
  // require('./components/foodList/foodList.module.js');
